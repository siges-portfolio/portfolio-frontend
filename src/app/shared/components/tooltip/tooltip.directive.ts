import { ApplicationRef, Directive, DOCUMENT, ElementRef, HostListener, inject, InjectionToken, Injector, input, OnInit, TemplateRef, ViewContainerRef } from "@angular/core";
